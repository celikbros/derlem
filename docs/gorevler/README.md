...
| [TASK-002](TASK-002-contribution-task-type-registry.md) | Contribution task-type registry (translation, preference, reasoning) | feature | DRAFT — **BLOCKED** (commit edilmemiş iş `main`'e girmeli; TASK-001 önce) + sahip kararı (D1–D4) |
