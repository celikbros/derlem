...
| [TASK-015](TASK-015-periodic-maintenance-sweep-inside-the-worker.md) | Periodic maintenance sweep inside the worker loop (TASK-014 follow-up) | fix | **DRAFT** — plan 2026-09-19, Faz 1, 0.5 gün |
...
| [TASK-017](TASK-017-hard-gate-no-pretrain-freeze-without.md) | Hard gate: no `pretrain` freeze without a registered eval/holdout reference source | fix | **DRAFT** — plan 2026-09-19, Faz 1, 0.5 gün |
