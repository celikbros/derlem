...
| [TASK-012](TASK-012-clean-candidate-v3.md) | Clean candidate v3: quality v2, held-out split, near-dedup, rejection report | feature | **IN PROGRESS** — 2026-09-18. Kod + testler + 100k uçtan uca koşu bitti (249 sn; 99.007 aday / 43 held-out / 937 kalite / 13 yakın kopya). Tam üretim (~4 saat) sahibin zaman seçmesini bekliyor. Dil kuralı yok: lingua'nın işaretlediklerinin %64'ü Türkçe çıktı. |
