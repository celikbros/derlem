...
| [TASK-039](TASK-039-zlib-dependent-compression-rule.md) | `tr-web-*` compression-ratio rule depends on the zlib implementation (3.14 zlib-ng vs 3.13 zlib) | fix | **DRAFT** — 2026-09-20: v4'te 7 sınır satırı; manifeste zlib sürümü + uygulamadan bağımsız ölçüt (`tr-web-v3`), v5 öncesi |
