...
| [TASK-014](TASK-014-lineage-family-dedup.md) | Normalized dedup quarantines a source's own lineage family | fix | **IN REVIEW** — 2026-09-19. Tekrar kapısı yalnız ataları dışarıda tutuyordu; kardeş adaylar (v1/v3) ve parent'ın kayıtsız ham girdileri birbirini karantinaya sokacaktı. `source_lineage_inputs` (000029, çoklu girdi) + "soy ailesi" dışlaması; API `lineage_input_source_ids`. Testler yeşil, kontrol koşusu kırmızı. Bekleyen: migration'ın çalışma DB'sine uygulanması (sahip), worker yeniden başlatma, parent girdilerinin bildirilmesi. |
