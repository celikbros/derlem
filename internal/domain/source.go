...
type Source struct {
	...
	NormalizedDedupStatus          string    `json:"normalized_dedup_status"`
	NormalizedDuplicateCount       int64     `json:"normalized_duplicate_count"`
	NormalizedDuplicateSourceCount int64     `json:"normalized_duplicate_source_count"`
