...
func protectedRoutes(s *Server) []protectedRoute {
	return []protectedRoute{
		...
		{"POST /api/v1/sources/{id}/ingest", []string{roleAdmin}, s.queueSourceIngest},
		...
		{"GET /api/v1/sources/{id}/document-review-history", reviewerRoles, s.listMySourceDocumentReviewHistory},
		...
		{"POST /api/v1/sources/{id}/documents/claims", reviewerRoles, s.claimSourceDocuments},
		...
		{"POST /api/v1/document-reviews/{id}/reversal", reviewerRoles, s.reverseDocumentReview},
